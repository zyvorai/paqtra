...
✅ **With Simulator:**
```bash
$ cilium-vision simulate --block 8.8.8.8
...
```rust
use cilium_vision::modules::simulator::*;
...
cilium-vision simulate block-ip 8.8.8.8

# Simulate a policy file
cilium-vision simulate apply-policy new-policy.yaml

# Simulate default-deny
cilium-vision simulate default-deny --namespace prod

# Compare multiple scenarios
cilium-vision simulate compare \
...
```bash
# Stage 1: Test in dev
cilium-vision simulate --cluster dev apply-policy.yaml

# Stage 2: Test in staging
cilium-vision simulate --cluster staging apply-policy.yaml
