    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <ExportButton data={services as unknown as Record<string, unknown>[]} filename="latency-analysis" />
      ...
      {!loading && services.length === 0 && !error && (
        <div className="text-center py-12 text-slate-400">No latency data available.</div>
      )}
